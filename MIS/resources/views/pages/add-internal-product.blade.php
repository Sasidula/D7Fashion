<x-app-layout>
    ...
    >
        ...
        <div class="flex-1 flex overflow-hidden">
            <!-- Sidebar -->
            @include('components.sidebar', ['currentPage' => 'add-internal-product'])
            ...
            <div class="flex-1 overflow-y-auto transition-all duration-300 ease-in-out">
                <main class="p-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-20 flex flex-col items-center">
                        <h2 class="text-2xl font-bold mb-6 text-[#2a3f7d]">Add Internal Product - in</h2>

                        <form method="POST" action="{{ route('InternalProducts.add') }}">
                            @method('POST')
                            @csrf
