<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <h2 class="text-2xl font-bold mb-6 text-[#2a3f7d]">Edit External Product details</h2>

    <form>

        <div class="w-80 flex justify-center flex-col pb-10">
            <label class="block text-gray-700 mb-1" for="fullName">Select Product Name</label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
                <label class="block text-gray-700 mb-1" for="email">Selling Price</label>
            ...
            <div>
                <label class="block text-gray-700 mb-1" for="email">SKU No (Optional )</label>
                <input id="email" type="email" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
